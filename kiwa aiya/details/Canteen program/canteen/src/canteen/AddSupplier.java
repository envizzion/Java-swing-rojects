...
public class AddSupplier extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("T.P");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 140, 28, -1));
        ...
        getContentPane().add(Name, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 100, 206, -1));
        ...
        getContentPane().add(TP, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 140, 206, -1));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 0, 230, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         try {
            ...
            s1.executeUpdate("insert into supplier(Sup_name,Sup_address) values( '" +Name.getText() + "','" + Address.getText() +"')");
            
            ResultSet r1=s1.executeQuery("SELECT * FROM supplier order by Sup_ID desc limit 1");
                   // s2.executeQuery("select Sup_ID from supplier where Sup_name='"+Name.getText()+"' and Address ='"+Address.getText()+"'");
            while(r1.next()){
              // String x= r1.getString("Sup_ID");
               // System.out.println(x);
              s2.executeUpdate("insert into sup_tp_nos values('"+TP.getText()+"','"+r1.getString("Sup_ID")+"')");
            }
